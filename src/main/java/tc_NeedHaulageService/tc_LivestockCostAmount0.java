...
public class tc_LivestockCostAmount0 {
...
//        assertTrue(driver.getTitle().contains("Preview"));
        ...
        try {
            ...
            report.test.log(LogStatus.PASS, "Displaying Success Message Successfully");
        }catch (Exception e){
            e.printStackTrace();
        ...
        try {
            ...
            driver.findElement(By.xpath("//input[@id=\"total\"]")).sendKeys("0");
            report.test.log(LogStatus.PASS, "Entered Correct Service Total Km's");
        }catch (Exception e){
            e.printStackTrace();
            report.test.log(LogStatus.FAIL,"Entered Wrong Service Total Km's");
        }
        ...
        try {
            ...
            driver.findElement(By.xpath("//input[@formcontrolname=\"livestockTransportTotalCost\"] ")).sendKeys("0");
            report.test.log(LogStatus.PASS, "Entered Correct Service Manual Amount");
        }catch (Exception e){
            e.printStackTrace();
            report.test.log(LogStatus.FAIL,"Entered Wrong Service Manual Amount");
        }
