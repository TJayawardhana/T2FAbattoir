...
public class tc_EnterOnlyLivestockTotalKM {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            ...
            report.test.log(LogStatus.PASS, "Haulage Service Selected Successfully");
        } catch (Exception e) {
            e.printStackTrace();
        ...
        Thread.sleep(3000);
            ...
            try {
                ...
                report.test.log(LogStatus.PASS, "Displaying Message Successfully");
            } catch (Exception e) {
                e.printStackTrace();
                report.test.log(LogStatus.FAIL, "Successful Message is not Display");
            }
