...
public class tc_AddingOnlyOffalDeliveryManualAmount {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            ...
            driver.findElement(By.xpath("//input[@formcontrolname=\"meatDeliveryTotalCost\"]")).sendKeys("null");
        ...
        try {
            ...
            driver.findElement(By.xpath("//input[@formcontrolname=\"offalDeliveryTotalCost\"]")).sendKeys("30");
