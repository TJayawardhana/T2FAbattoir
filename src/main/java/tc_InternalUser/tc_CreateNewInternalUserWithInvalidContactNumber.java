...
public class tc_CreateNewInternalUserWithInvalidContactNumber {
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.findElement(By.xpath("//input[@formcontrolname=\"contactNumber\"]")).sendKeys("0125553456789");
