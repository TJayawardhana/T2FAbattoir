...
public class tc_SetupAssignHaulageAndServiceCostAndCancel {
...
//        assertTrue(driver.getTitle().contains("Preview"));
        ...
        try {
            ...
            report.test.log(LogStatus.PASS, "Selected Haulage Service");
        }catch (Exception e){
            e.printStackTrace();
        ...
        try {
            ...
            driver.findElement(By.xpath("//input[@id=\"total\"]")).sendKeys("20");
            report.test.log(LogStatus.PASS, "Entered Correct Haulage Service Total Km's");
        }catch (Exception e){
            e.printStackTrace();
            report.test.log(LogStatus.FAIL,"Entered Wrong Haulage Service Total Km's");
        }
        Thread.sleep(5000);
        ...
        try {
            ...
            driver.findElement(By.xpath("//input[@formcontrolname=\"livestockTransportTotalCost\"]")).sendKeys("25");
            report.test.log(LogStatus.PASS, "Entered Correct Haulage Service Manual Amount");
        }catch (Exception e){
            e.printStackTrace();
            report.test.log(LogStatus.FAIL,"Entered Wrong Haulage Service Manual Amount");
        }
