...
public class tc_SetupHaulageServiceCost {
...
//        assertTrue(driver.getTitle().contains("Preview"));
        ...
        try {
            ...
            report.test.log(LogStatus.PASS, "Added Haulage Service Correct Total Km's");
        }catch (Exception e){
            e.printStackTrace();
            report.test.log(LogStatus.FAIL,"Added Haulage Service Wrong Total Km's");
        }
        ...
        try {
            ...
            report.test.log(LogStatus.PASS, "Added Haulage Service Correct Manual Amount");
        }catch (Exception e){
            e.printStackTrace();
            report.test.log(LogStatus.FAIL,"Added Haulage Service Wrong Manual Amount");
        }
