...
public class tc_EnterOnlyManualLivestockAmount {
...
//        assertTrue(driver.getTitle().contains("Preview"));
        ...
        try {
            ...
            e.printStackTrace();
            report.test.log(LogStatus.FAIL,"Assign Haulage is not Clickable");
        }
        ...
        try {
            ...
            report.test.log(LogStatus.PASS, "Successfully Assigned a Haulage");
        }catch (Exception e){
            e.printStackTrace();
            report.test.log(LogStatus.FAIL,"Assign Haulage is not Clickable");
        }
        ...
        try {
            ...
            report.test.log(LogStatus.PASS, "Displaying Verify Success Message");
        }catch (Exception e){
            e.printStackTrace();
            report.test.log(LogStatus.FAIL,"Verify Success Message is not Displaying");
        }
        ...
        try {
            ...
            report.test.log(LogStatus.PASS, "Entered Manual Amount");
        }catch (Exception e){
            e.printStackTrace();
            report.test.log(LogStatus.FAIL,"Enter Amount Wrongly");
        }
