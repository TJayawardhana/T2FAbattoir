...
public class tc_AssignHaulagesWithCosts {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            ...
            report.test.log(LogStatus.PASS, "Meat Delivery Service is Selected");
        }catch (Exception e){
            e.printStackTrace();
            report.test.log(LogStatus.FAIL,"Meat Delivery Service is not Selected");
        }
        ...
        try {
            ...
            report.test.log(LogStatus.PASS, "Offal Delivery Service is Selected");
        }catch (Exception e){
            e.printStackTrace();
            report.test.log(LogStatus.FAIL,"Offal Delivery Service is not Selected");
        }
