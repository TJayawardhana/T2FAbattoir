...
//        assertTrue(driver.getTitle().contains("Preview"));
        ...
        try {
            ...
            report.test.log(LogStatus.PASS, "Approve or Reject Button is Clickable");
        }catch (Exception e){
            e.printStackTrace();
            report.test.log(LogStatus.FAIL,"Approve or Reject Button is not Clickable");
        }
        ...
        try {
            ...
            report.test.log(LogStatus.PASS, "Displaying Booking Approve Message Successfully");
        }catch (Exception e){
            e.printStackTrace();
            report.test.log(LogStatus.FAIL,"Booking Approve Message is not Displaying");
        }
