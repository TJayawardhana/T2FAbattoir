...
public class tc_EmptyDeliveryCost {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.findElement(By.xpath("(//input[@id=\"total\"])[1]")).sendKeys("");
        // Meat Delivery Manual Amount
        driver.findElement(By.xpath("//input[@formcontrolname=\"meatDeliveryTotalCost\"]")).clear();
        driver.findElement(By.xpath("//input[@formcontrolname=\"meatDeliveryTotalCost\"]")).sendKeys("");
        // Offal Delivery Total KM
        driver.findElement(By.xpath("(//input[@id=\"total\"])[2]")).clear();
        driver.findElement(By.xpath("(//input[@id=\"total\"])[2]")).sendKeys("");
        // Offal Delivery Manual Amount
        driver.findElement(By.xpath("//input[@formcontrolname=\"offalDeliveryTotalCost\"]")).clear();
        driver.findElement(By.xpath("//input[@formcontrolname=\"offalDeliveryTotalCost\"]")).sendKeys("");

        // Click on Send Request But
