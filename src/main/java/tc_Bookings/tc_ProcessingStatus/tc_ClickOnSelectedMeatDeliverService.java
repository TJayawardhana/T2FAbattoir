...
public class tc_ClickOnSelectedMeatDeliverService {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // Click on Selected Delivery Service
        driver.findElement(By.xpath("(//button[text()='Select'])[2]")).click();

        Thread.sleep(5000);

        // Verify Message
        String expectedText =" JKL already selected as meat delivery service ";
        Assert.assertEquals(" JKL already selected as meat delivery service ",expectedText);
