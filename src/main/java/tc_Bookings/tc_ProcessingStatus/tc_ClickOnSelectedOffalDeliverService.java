...
public class tc_ClickOnSelectedOffalDeliverService {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // Click on Selected Offal Service
        driver.findElement(By.xpath("(//button[text()='Select'])[3]")).click();

        Thread.sleep(5000);

        // Verify Message
        String expectedText =" GHI already selected as offal delivery service ";
        Assert.assertEquals(" GHI already selected as offal delivery service ",expectedText);
