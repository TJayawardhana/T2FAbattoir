package tc_Bookings.tc_DeliverStatus;
...
public class tc_VerifyDeliverPreviewPageAndBack {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            ...
            report.test.log(LogStatus.PASS, "Back is Clickable");
        }catch (Exception e){
            e.printStackTrace();
            report.test.log(LogStatus.FAIL,"Back is not Clickable");
        }
